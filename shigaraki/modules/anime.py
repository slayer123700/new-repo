...
from shigaraki.anime.data_parser import (
    get_all_genres,
    get_all_tags,
    get_studio_animes,
    get_studios,
...
from shigaraki.anime.helper import (
    clog,
    check_user,
    get_btns,
    rand_key,
...
from shigaraki.anime.db import get_collection
...
"""𝖯𝗅𝖾𝖺𝗌𝖾 𝗀𝗂𝗏𝖾 𝖺 𝗊𝗎𝖾𝗋𝗒 𝗍𝗈 𝗌𝖾𝖺𝗋𝖼𝗁 𝖺𝖻𝗈𝗎𝗍

𝖾𝗑𝖺𝗆𝗉𝗅𝖾: /𝖺𝗇𝗂𝗆𝖾 𝖲𝗐𝗈𝗋𝖽 𝖠𝗋𝗍 𝖮𝗇𝗅𝗂𝗇𝖾"""
        )
    ...
    if await (
        ...
        await client.send_photo(
            ...
            caption="𝖳𝗁𝗂𝗌 𝖺𝗇𝗂𝗆𝖾 𝗂𝗌 𝗆𝖺𝗋𝗄𝖾𝖽 𝟣𝟪+ 𝖺𝗇𝖽 𝗇𝗈𝗍 𝖺𝗅𝗅𝗈𝗐𝖾𝖽 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉"
        )
        return
    try:
        await client.send_photo(
        ...
        await clog('shigaraki', title_img, 'LINK', msg=message)
        await client.send_photo(
...
𝖾𝗑𝖺𝗆𝗉𝗅𝖾: /𝗆𝖺𝗇𝗀𝖺 𝖲𝗐𝗈𝗋𝖽 𝖠𝗋𝗍 𝖮𝗇𝗅𝗂𝗇𝖾"""
        )
        await asyncio.sleep(5)
        return await k.delete()
    query = text[1]
    ...
    if await (SFW_GRPS.find_one({"id": gid})) and result[2].pop() == "True":
        ...
        await client.send_photo(
            gid,
            no_pic[random.randint(0, 4)],
            caption="𝖳𝗁𝗂𝗌 𝗆𝖺𝗇𝗀𝖺 𝗂𝗌 𝗆𝖺𝗋𝗄𝖾𝖽 𝟣𝟪+ 𝖺𝗇𝖽 𝗇𝗈𝗍 𝖺𝗅𝗅𝗈𝗐𝖾𝖽 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉",
    ...
    try:
        ...
        await clog('shigaraki', pic, 'LINK', msg=message)
        await client.send_photo(
            gid, failed_pic, caption=finals_, reply_markup=buttons
        )
...
async def character_cmd(client: Client, message: Message, mdata: dict):
    ...
    try:
        ...
        await clog('shigaraki', img, 'LINK', msg=message)
        await client.send_photo(
...
async def anilist_cmd(client: Client, message: Message, mdata: dict):
    ...
    if len(text) == 1:
        k = await message.reply_text(
            "𝖯𝗅𝖾𝖺𝗌𝖾 𝗀𝗂𝗏𝖾 𝖺 𝗊𝗎𝖾𝗋𝗒 𝗍𝗈 𝗌𝖾𝖺𝗋𝖼𝗁 𝖺𝖻𝗈𝗎𝗍\n𝖾𝗑𝖺𝗆𝗉𝗅𝖾: /𝖺𝗇𝗂𝗅𝗂𝗌𝗍 𝖲𝗐𝗈𝗋𝖽 𝖠𝗋𝗍 𝖮𝗇𝗅𝗂𝗇𝖾"
        )
        await asyncio.sleep(5)
        return await k.delete()
    query = text[1]
...
@app.on_message(filters.command(["topanime", f"topanime{BOT_USERNAME}"]))
@control_user
async def top_tags_cmd(client: Client, message: Message, mdata: dict):
    ...
    if await (SFW_GRPS.find_one({"id": gid})) and str(result[0][1]) == "True":
        return await message.reply_text(
            '𝖭𝗈 𝗇𝗌𝖿𝗐 𝗌𝗍𝗎𝖿𝖿 𝖺𝗅𝗅𝗈𝗐𝖾𝖽 𝗂𝗇 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉!!!'
        )
    msg, buttons = result
...
𝖾𝗑𝖺𝗆𝗉𝗅𝖾: /𝖺𝗂𝗋𝗂𝗇𝗀 𝖲𝗐𝗈𝗋𝖽 𝖠𝗋𝗍 𝖮𝗇𝗅𝗂𝗇𝖾""")
        await asyncio.sleep(5)
        return await k.delete()
    query = text[1]
    qdb = rand_key()
    ...
    try:
        ...
        await clog('shigaraki', coverImg, 'LINK', msg=message)
        await client.send_photo(gid, failed_pic, caption=out, reply_markup=btn)



setting_text = """
<𝖻>𝖳𝗁𝗂𝗌 𝖺𝗅𝗅𝗈𝗐𝗌 𝗒𝗈𝗎 𝗍𝗈 𝖼𝗁𝖺𝗇𝗀𝖾 𝗀𝗋𝗈𝗎𝗉 𝗌𝖾𝗍𝗍𝗂𝗇𝗀𝗌</𝖻>
        
𝖭𝖲𝖥𝖶 𝗍𝗈𝗀𝗀𝗅𝖾 𝗌𝗐𝗂𝗍𝖼𝗁𝖾𝗌 𝗈𝗇 𝖿𝗂𝗅𝗍𝖾𝗋𝗂𝗇𝗀 𝗈𝖿 𝟣𝟪+ 𝗆𝖺𝗋𝗄𝖾𝖽 𝖼𝗈𝗇𝗍𝖾𝗇𝗍

𝖠𝗂𝗋𝗂𝗇𝗀 𝗇𝗈𝗍𝗂𝖿𝗂𝖼𝖺𝗍𝗂𝗈𝗇𝗌 𝗇𝗈𝗍𝗂𝖿𝗂𝖾𝗌 𝖺𝖻𝗈𝗎𝗍 𝖺𝗂𝗋𝗂𝗇𝗀 𝗈𝖿 𝖺𝗇𝗂𝗆𝖾 𝗂𝗇 𝗋𝖾𝖼𝖾𝗇𝗍

𝖢𝗋𝗎𝗇𝖼𝗁𝗒𝗋𝗈𝗅𝗅 𝗎𝗉𝖽𝖺𝗍𝖾𝗌 𝗐𝗂𝗅𝗅 𝗍𝗈𝗀𝗀𝗅𝖾 𝗇𝗈𝗍𝗂𝖿𝗂𝖼𝖺𝗍𝗂𝗈𝗇𝗌 𝖺𝖻𝗈𝗎𝗍 𝗋𝖾𝗅𝖾𝖺𝗌𝖾 𝗈𝖿 𝖺𝗇𝗂𝗆𝖾𝗌 𝗈𝗇 𝖼𝗋𝗎𝗇𝖼𝗁𝗒𝗋𝗈𝗅𝗅 𝗌𝗂𝗍𝖾

𝖲𝗎𝖻𝗌𝗉𝗅𝖾𝖺𝗌𝖾 𝗎𝗉𝖽𝖺𝗍𝖾𝗌 𝗐𝗂𝗅𝗅 𝗍𝗈𝗀𝗀𝗅𝖾 𝗇𝗈𝗍𝗂𝖿𝗂𝖼𝖺𝗍𝗂𝗈𝗇𝗌 𝖺𝖻𝗈𝗎𝗍 𝗋𝖾𝗅𝖾𝖺𝗌𝖾 𝗈𝖿 𝖺𝗇𝗂𝗆𝖾𝗌 𝗈𝗇 𝗌𝗎𝖻𝗌𝗉𝗅𝖾𝖺𝗌𝖾 𝗌𝗂𝗍𝖾

𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝖺𝖽𝗅𝗂𝗇𝖾𝗌 𝖻𝗎𝗍𝗍𝗈𝗇 𝗍𝗈 𝖾𝗇𝖺𝖻𝗅𝖾 𝗁𝖾𝖺𝖽𝗅𝗂𝗇𝖾𝗌. 𝖸𝗈𝗎 𝖼𝖺𝗇 𝖼𝗁𝗈𝗈𝗌𝖾 𝖿𝗋𝗈𝗆 𝗀𝗂𝗏𝖾𝗇 𝗌𝗈𝗎𝗋𝖼𝖾𝗌"""
...
This material is marked 18+ and not allowed in this group"""
    ...
    try:
        ...
        await clog('shigaraki', pic, 'LINK', msg=cq)
        await cq.edit_message_media(
...
headlines_text = '''
𝖳𝗎𝗋𝗇 𝖫𝗂𝗏𝖾𝖢𝗁𝖺𝗋𝗍 𝗈𝗉𝗍𝗂𝗈𝗇 𝗈𝗇 𝗍𝗈 𝗀𝖾𝗍 𝗇𝖾𝗐𝗌 𝖿𝖾𝖾𝖽𝗌 𝖿𝗋𝗈𝗆 𝗅𝗂𝗏𝖾𝖼𝗁𝖺𝗋𝗍.𝗆𝖾
𝖳𝗎𝗋𝗇 𝖬𝗒𝖠𝗇𝗂𝗆𝖾𝖫𝗂𝗌𝗍 𝗈𝗉𝗍𝗂𝗈𝗇 𝗈𝗇 𝗍𝗈 𝗀𝖾𝗍 𝗇𝖾𝗐𝗌 𝖿𝖾𝖾𝖽𝗌 𝖿𝗋𝗈𝗆 𝗆𝗒𝖺𝗇𝗂𝗆𝖾𝗅𝗂𝗌𝗍.𝗇𝖾𝗍

𝖥𝗈𝗋 𝖠𝗎𝗍𝗈 𝖯𝗂𝗇 𝖺𝗇𝖽 𝖠𝗎𝗍𝗈 𝖴𝗇𝗉𝗂𝗇 𝖿𝖾𝖺𝗍𝗎𝗋𝖾𝗌, 𝗀𝗂𝗏𝖾 𝗍𝗁𝖾 𝖻𝗈𝗍 "𝖯𝗂𝗇 𝖬𝖾𝗌𝗌𝖺𝗀𝖾" 𝖺𝗇𝖽 "𝖣𝖾𝗅𝖾𝗍𝖾 𝖬𝖾𝗌𝗌𝖺𝗀𝖾" 𝗉𝖾𝗋𝗆𝗌
𝖠𝗎𝗍𝗈 𝖴𝗇𝗉𝗂𝗇 𝖼𝖺𝗇 𝖻𝖾 𝖼𝗎𝗌𝗍𝗈𝗆𝗂𝗓𝖾𝖽, 𝖼𝗅𝗂𝖼𝗄 𝗈𝗇 𝗍𝗁𝖾 𝖻𝗎𝗍𝗍𝗈𝗇 𝗍𝗈 𝗌𝖾𝖾 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝗈𝗉𝗍𝗂𝗈𝗇𝗌
'''
...
async def headlines_btn(client: Client, cq: CallbackQuery):
    ...
    if cus != OWNER and k == MEMBER:
        await cq.answer(
            "𝖸𝗈𝗎 𝖽𝗈𝗇'𝗍 𝗁𝖺𝗏𝖾 𝖾𝗇𝗈𝗎𝗀𝗁 𝗉𝖾𝗋𝗆𝗂𝗌𝗌𝗂𝗈𝗇𝗌 𝗍𝗈 𝖼𝗁𝖺𝗇𝗀𝖾 𝗍𝗁𝗂𝗌!!!",
            show_alert=True
        )
        return
...
async def auto_unpin(client: Client, cq: CallbackQuery):
    ...
    if data:
        ...
        cancel = True
    if cancel:
        return await cq.answer(f"𝖯𝗅𝖾𝖺𝗌𝖾 𝖾𝗇𝖺𝖻𝗅𝖾 {𝗌𝗋𝖼𝗇𝖺𝗆𝖾} 𝖺𝗇𝖽 𝖠𝗎𝗍𝗈 𝖯𝗂𝗇 𝗈𝗉𝗍𝗂𝗈𝗇 𝖿𝗈𝗋 𝗍𝗁𝖾𝗆!!!", show_alert=True)
    setting = None
    if qry=="call":
        pass
    elif qry == "None":
...
__help__ = """**✧ /𝖺𝗇𝗂𝗆𝖾 (𝖺𝗇𝗂𝗆𝖾 𝗇𝖺𝗆𝖾)** - 𝖳𝗈 𝖦𝖾𝗍 𝖳𝗁𝖾 𝖠𝗇𝗂𝗆𝖾 𝖨𝗇𝖿𝗈
**✧ /𝗆𝖺𝗇𝗀𝖺 (𝗆𝖺𝗇𝗀𝖺 𝗇𝖺𝗆𝖾)** - 𝖳𝗈 𝖦𝖾𝗍 𝖳𝗁𝖾 𝖬𝖺𝗇𝗀𝖺 𝖨𝗇𝖿𝗈
**✧ /𝖼𝗁𝖺𝗋𝖺𝖼𝗍𝖾𝗋 (𝖼𝗁𝖺𝗋𝖺𝖼𝗍𝖾𝗋 𝗇𝖺𝗆𝖾)** - 𝖳𝗈 𝖦𝖾𝗍 𝖳𝗁𝖾 𝖢𝗁𝖺𝗋𝖺𝖼𝗍𝖾𝗋 𝖨𝗇𝖿𝗈
**✧ /𝗀𝖾𝗍𝗍𝖺𝗀𝗌** - 𝖳𝗈 𝖦𝖾𝗍 𝖳𝗁𝖾 𝖠𝗇𝗂𝗆𝖾 𝖦𝖾𝗇𝖾𝗋𝖾 𝖳𝖺𝗀𝗌
**✧ /𝖻𝗋𝗈𝗐𝗌𝖾** - 𝖳𝗈 𝖡𝗋𝗈𝗐𝗌𝖾 𝖳𝗁𝖾 𝖳𝗋𝖾𝗇𝖽𝗂𝗇𝗀/𝖴𝗉𝖼𝗈𝗆𝗂𝗇𝗀/𝖫𝖺𝗍𝖾𝗌𝗍 𝖠𝗇𝗂𝗆𝖾𝗌
**✧ /𝖺𝗇𝗂𝗌𝖾𝗍𝗍𝗂𝗇𝗀𝗌** - 𝖳𝗈 𝖦𝖾𝗍 𝖳𝗁𝖾 𝖲𝖾𝗍𝗍𝗂𝗇𝗀𝗌 𝖠𝖻𝗈𝗎𝗍 𝖠𝗇𝗂𝖫𝗂𝗌𝗍
**✧ /𝖺𝗂𝗋𝗂𝗇𝗀 (𝖺𝗇𝗂𝗆𝖾 𝗇𝖺𝗆𝖾)** - 𝖳𝗈 𝖦𝖾𝗍 𝖳𝗁𝖾 𝖠𝗂𝗋𝗂𝗇𝗀 𝖠𝗇𝗂𝗆𝖾𝗌
**✧ /𝗍𝗈𝗉𝖺𝗇𝗂𝗆𝖾** - 𝖳𝗈 𝖦𝖾𝗍 𝖳𝗁𝖾 𝖳𝗈𝗉 𝖠𝗇𝗂𝗆𝖾𝗌
"""