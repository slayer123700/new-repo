...
from shigaraki import app , AFK_REPLY_GROUP , AFK_RETURN_GROUP
from shigaraki.database.afk_db import get_afk, set_afk, clear_afk , get_afk_by_username
from shigaraki.helper.user import resolve_user_for_afk
from shigaraki.vars import random_afk_message , random_afk_reply_message , random_back_online_message
import random
